...
const ProductionOverview = ({system, planet, model, updateModel, onClose}) => {
    ...
    const warningIcon = productionChains.find(chain => chain.hasMissingRecipes)
        ? (<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="darkorange" className="w-6 h-6" onClick={_ => setShowConfigureRecipes({show: true, filter: ""})}>
