...
const Product = ({product, name, tooltip, productionRate}) => {
    ...
    const badgeItem = productionRate
        ? (
            <div className="z-10 text-xs absolute left-[15px] whitespace-nowrap bottom-[-8px] pl-1 pr-1 bg-violet-500 text-white outline outline-white outline-2 rounded-full">
