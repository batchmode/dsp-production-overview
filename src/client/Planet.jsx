...
const Planet = ({system, planet, model, updateModel, onShowProductionChain}) => {
    ...
    if (showImportSelection) {
        importSelection = (
            <Popup>
                <SelectProducts products={planet.imports.map(productById)} allProducts={model.products} onSave={onImportSave}
                                onCancel={onCancel}/>
            </Popup>
        )
    }
    ...
    if (showExportSelection) {
        exportSelection = (
            <Popup>
                <SelectProducts products={planet.exports.map(productById)} allProducts={model.products} onSave={onExportSave}
                                onCancel={onCancel}/>
            </Popup>
        )
    }
